                ...
                <div className="bg-white px-4 py-6 rounded-b-2xl">
                    <div className="flex items-center justify-center text-center font-dela-gothic-one">
                        <div className="flex-1 flex flex-col gap-3">
                            <span className="text-6xl text-black opacity-25">{formatTime(timeLeft.minutes)}</span>
                            <span className="text-sm font-semibold font-schibsted-grotesk" style={{ color: "#161616" }}>
                                MINUTES
                            </span>
                        </div>
                        ...
                        <div className="flex-1 flex flex-col gap-3">
                            <span className="text-6xl text-black opacity-25">{formatTime(timeLeft.seconds)}</span>
                            <span className="text-sm font-semibold font-schibsted-grotesk" style={{ color: "#161616" }}>
                                SECONDS
                            </span>
                        </div>
