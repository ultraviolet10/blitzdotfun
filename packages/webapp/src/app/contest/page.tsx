          ...
          <div className="text-center">
            <div className="bg-[#1A1A1A] rounded-lg border border-[#2A2A2A] p-8">
              ...
              <p className="text-gray-400 mb-6">
                Creators are preparing their content. The battle will begin once
                both participants have made their deposits and submitted their
                content.
              </p>
