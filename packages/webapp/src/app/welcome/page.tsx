...
function Welcome() {
    ...
    const handleDepositClick = () => {
        ...
        if (currentParticipant?.zoraProfile) {
            window.open(`https://zora.co/${currentParticipant.zoraProfile}`, "_blank")
                ...
                <div className="w-full max-w-xl text-center space-y-6">
                    <div className="space-y-2">
                        ...
                        >
                            ...
                            {opponent ? (
                                <a
                                    href={`https://zora.co/${opponent.zoraProfile || opponent.handle}`}
                                    target="_blank"
                                ...
                                <div>
                                    ...
                                    <p className="font-schibsted-grotesk text-black font-medium text-sm">
                                        ...
                                        {currentParticipant ? (
                                            <a
                                                href={`https://zora.co/${
                                                    currentParticipant.zoraProfile || currentParticipant.handle
                                                }`}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="underline hover:opacity-80 transition-opacity"
                    ...
                    >
                        <div className="flex justify-center items-center gap-2">
                            <span>Deposit ${currentParticipant ? currentParticipant.handle : "idk"}</span>
