                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <div className="flex items-center justify-center gap-4">
                            ...
                            <span className="text-gray-400">Battle starting soon</span>
                        </div>
                    </div>
                            ...
                            >
                                ...
                                <div className="mb-6">
                                    {participant.zoraProfileData?.avatar?.medium ? (
                                        ...
                                        <div
                                            className={`w-24 h-24 rounded-full mx-auto flex items-center justify-center text-2xl font-bold text-white ${
                                                index === 0
                                ...
                                <div className="space-y-3">
                                    ...
                                    {participant.zoraProfileData?.bio && (
                                        <p className="text-gray-400 text-sm">{participant.zoraProfileData.bio}</p>
                                    )}
                    ...
                    <div className="text-center mb-12">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center">
                                <span className="bg-[#121212] px-6 text-4xl font-bold text-[#67CE67]">VS</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#1A1A1A] rounded-lg border border-[#2A2A2A] p-8 text-center">
                        <h3 className="text-2xl font-bold text-white mb-4">Get Ready for the Battle!</h3>
                        <p className="text-gray-400 mb-6">
                            These creators are preparing their content. The battle will begin once both participants
                            have made their deposits and submitted their content.
                        </p>
