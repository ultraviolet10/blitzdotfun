...
export default function AdminPage() {
    ...
    const completeContest = async (contestId: string) => {
        try {
            setLoading(true)
            const response = await fetch(`/api/admin/contests/${contestId}/complete`, {
                method: "PATCH",
            ...
            <div className="max-w-6xl mx-auto">
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-white font-mono">{activeContest.contestId}</p>
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    {activeContest.participants.map((participant) => (
                                        <div key={participant.walletAddress} className="bg-[#2A2A2A] p-3 rounded">
                ...
                <div className="bg-[#1A1A1A] rounded-lg border border-[#2A2A2A] p-6 mb-8">
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <h2 className="block text-gray-400 mb-2">Contest Name</h2>
                                <input
                                    type="text"
                            ...
                            <div>
                                <h2 className="block text-gray-400 mb-2">Contract Address</h2>
                                <input
                                    type="text"
                    ...
                    {contests.length === 0 ? (
                        ...
                        <div className="space-y-4">
                            {contests.map((contest) => (
                                <div key={contest.contestId} className="bg-[#2A2A2A] p-4 rounded">
                                    <div className="flex justify-between items-start mb-2">
                                        <div>
                                            <h3 className="text-white font-medium">{contest.name}</h3>
                                            <p className="text-gray-400 text-sm font-mono">{contest.contestId}</p>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 text-sm">
                                        {contest.participants.map((participant) => (
                                            <div key={participant.walletAddress}>
                                                ...
                                                <p className="text-gray-400 font-mono">{participant.walletAddress}</p>
                                            </div>
                                        ))}
                                    </div>
                                </div>
